 ...
 * vkutils.h
 *
 * Collection of helpers functions for the Vulkan application
 *
 * CompGeom
 * Ludovic Blache
 *
...
namespace CompGeom
{
    ...
    */
     ...
     */
    inline VkPresentModeKHR chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& _availablePresentModes)
    {
     ...
     */
    inline VkExtent2D chooseSwapExtent(const VkSurfaceCapabilitiesKHR& _capabilities, GLFWwindow* _window) 
    {
